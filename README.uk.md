...
У виробництві дефіцит однієї критичної комплектуючої може зупинити збірку всього замовлення. Класична ділема: автоматика швидка, але безконтрольна; ручний процес контрольний, але повільний і непрозорий.
...
![Аналіз ризику RISK-001: ШІ-аналіз, рекомендація та кнопка «Передати на погодження»](docs/assets/demo/demo-manager-risk-analysis-uk.png)
...
|-----------------|------|------------------|
| `manager.demo` | Керівник виробництва | Ініціює процеси, створює запити на погодження — не може само-погоджувати |
...
| ШІ/ML | ARQ + Redis, OpenAI-сумісний провайдер чату, векторні вкладення pgvector |
...
- Кожна наслідкова дія проходить людське погодження.
...
|-------|-----------|-----------|
| Бекенд (юніт + інтеграція) | pytest | Ризик-рушій, машина станів, ШІ-провайдер, погодження/закупівлі, аудит, RBAC |
...
| Приймальні тести | Власний харнес | AT-003 … AT-013 — 11 PASS |
