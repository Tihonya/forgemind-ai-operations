...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['product_id'], ['products.id'],
                                ondelete='CASCADE',
                                name='fk_product_versions_product_id'),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['product_version_id'], ['product_versions.id'],
                                ondelete='CASCADE',
                                name='fk_bom_items_product_version_id'),
    ...
    op.create_index('idx_production_plans_code', 'production_plans',
                    ['code'], unique=True)
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['production_plan_id'], ['production_plans.id'],
                                ondelete='CASCADE',
                                name='fk_production_orders_plan_id'),
        sa.ForeignKeyConstraint(['product_version_id'], ['product_versions.id'],
                                ondelete='CASCADE',
                                name='fk_production_orders_product_version_id'),
    )
    op.create_index('idx_production_orders_code', 'production_orders',
                    ['code'], unique=True)
    op.create_index('idx_production_orders_plan_id', 'production_orders',
                    ['production_plan_id'])
    op.create_index(
        'idx_production_orders_product_version_id',
        'production_orders', ['product_version_id'],
    )
    op.create_index('idx_production_orders_need_date', 'production_orders',
                    ['need_date'])
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['component_id'], ['components.id'],
                                ondelete='CASCADE',
                                name='fk_inventory_balances_component_id'),
        sa.ForeignKeyConstraint(['warehouse_id'], ['warehouses.id'],
                                ondelete='CASCADE',
                                name='fk_inventory_balances_warehouse_id'),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['component_id'], ['components.id'],
                                ondelete='CASCADE',
                                name='fk_inventory_reservations_component_id'),
        sa.ForeignKeyConstraint(['warehouse_id'], ['warehouses.id'],
                                ondelete='CASCADE',
                                name='fk_inventory_reservations_warehouse_id'),
    ...
    op.create_index('idx_purchase_orders_po_number', 'purchase_orders',
                    ['po_number'], unique=True)
    op.create_index('idx_purchase_orders_supplier_id', 'purchase_orders',
                    ['supplier_id'])
    op.create_index('idx_purchase_orders_placed_at', 'purchase_orders',
                    ['placed_at'])
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['purchase_order_id'], ['purchase_orders.id'],
                                ondelete='CASCADE',
                                name='fk_purchase_order_lines_po_id'),
        sa.ForeignKeyConstraint(['component_id'], ['components.id'],
                                ondelete='CASCADE',
                                name='fk_purchase_order_lines_component_id'),
    )
    op.create_index('idx_purchase_order_lines_po_id',
                    'purchase_order_lines', ['purchase_order_id'])
    op.create_index('idx_purchase_order_lines_component_id',
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['production_order_id'], ['production_orders.id'],
                                ondelete='CASCADE',
                                name='fk_production_order_requirements_order_id'),
        sa.ForeignKeyConstraint(['component_id'], ['components.id'],
                                ondelete='CASCADE',
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['component_id'], ['components.id'],
                                ondelete='CASCADE',
                                name='fk_component_alternatives_component_id'),
        sa.ForeignKeyConstraint(
            ['alternative_component_id'], ['components.id'],
            ondelete='CASCADE',
            name='fk_component_alternatives_alt_component_id',
        ),
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index('idx_component_alternatives_comp_alt',
                  table_name='component_alternatives')
    op.drop_table('component_alternatives')

    # production_order_requirements (depends on production_orders, components)
    op.drop_index('idx_production_order_requirements_component_id',
                  table_name='production_order_requirements')
    op.drop_index('idx_production_order_requirements_order_id',
                  table_name='production_order_requirements')
    op.drop_table('production_order_requirements')

    # purchase_order_lines (depends on purchase_orders, components)
    op.drop_index('idx_purchase_order_lines_expected_delivery_date',
                  table_name='purchase_order_lines')
    op.drop_index('idx_purchase_order_lines_component_id',
                  table_name='purchase_order_lines')
    op.drop_index('idx_purchase_order_lines_po_id',
                  table_name='purchase_order_lines')
    op.drop_table('purchase_order_lines')

    # purchase_orders (depends on suppliers)
    op.drop_index('idx_purchase_orders_placed_at',
                  table_name='purchase_orders')
    op.drop_index('idx_purchase_orders_supplier_id',
                  table_name='purchase_orders')
    op.drop_index('idx_purchase_orders_po_number',
                  table_name='purchase_orders')
    ...
    op.drop_index('idx_inventory_reservations_comp_wo',
                  table_name='inventory_reservations')
    op.drop_table('inventory_reservations')

    # inventory_balances (depends on components, warehouses)
    op.drop_index('idx_inventory_balances_comp_wh',
                  table_name='inventory_balances')
    op.drop_table('inventory_balances')

    # production_orders (depends on production_plans, product_versions)
    op.drop_index('idx_production_orders_need_date',
                  table_name='production_orders')
    op.drop_index('idx_production_orders_product_version_id',
                  table_name='production_orders')
    op.drop_index('idx_production_orders_plan_id',
                  table_name='production_orders')
    ...
    op.drop_index('idx_bom_items_product_version_id_component_id',
    ...
    op.drop_index('idx_product_versions_product_id_version',
