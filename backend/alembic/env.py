...
def _to_sync_url(async_url: str) -> str:
    """Convert async database URL to sync-compatible URL for Alembic.

    Args:
        async_url: Database URL with async driver (e.g. postgresql+asyncpg://).

    Returns:
        Database URL with sync driver (postgresql+psycopg://).
    """
