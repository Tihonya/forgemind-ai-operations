...
![Аналіз ризику RISK-001: картка ризику з критичністю, блоки «Аналіз ШІ» та «Рекомендація ШІ» з варіантами дій](assets/demo/demo-manager-risk-analysis-uk.png)
