...
10. **Phase 7** (Public Deployment) — PLANNING AUTHORIZED (DEC-054, 2026-08-17). The authoritative Release 1 / Phase 7 deployment contract and controlled decomposition are defined in `docs/planning/phase_7_deployment_contract.md` (WP-P7-01). The contract records Product Owner deployment decisions PD-1 through PD-11 (with corrected PD-3, PD-3a, and PD-6), a dependency-ordered work-package decomposition (WP-P7-01 through WP-P7-12), staging/production/release gates, a VPS security-hardening contract, and a Hostinger and domain input contract. Until WP-P7-01 is merged and post-merge verified, Phase 7 remains NOT STARTED on GitHub main. Deployment execution, staging, and production remain NOT STARTED. Release 1 remains NOT READY / NOT DEPLOYED.
