...
- WP-P7-03 (Isolated Demo Environment and deterministic reset implementation — reframed by DEC-056, 2026-08-19): IN PROGRESS (implementation branch `feat/wp-p7-03-demo-reset`, Draft PR, not merged). WP-P7-04 (login UX) and WP-P7-05 (release documentation): NOT STARTED.
